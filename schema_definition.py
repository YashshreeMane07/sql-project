SCHEMA = {
    "students": [
        "student_id", "enrollment_no", "first_name", "last_name", "dob",
        "gender", "email", "phone", "department", "program",
    ...
    "results": [
        ...
        "marks_obtained", "grade", "grade_point"
    ],
    "fees": [
        "fee_id", "student_id", "semester",
        "total_amount", "amount_paid",
        "due_date", "status"
    ],
    "fee_payments": [
        "payment_id", "fee_id", "payment_mode",
        "transaction_reference", "payment_date", "amount"
    ],
    "hostel": ["hostel_id", "hostel_name", "capacity"],
    "hostel_rooms": [
        "room_id", "hostel_id", "room_number",
        "room_type", "capacity"
    ],
    "hostel_allocation": [
        "allocation_id", "student_id",
        "room_id", "allocation_date", "checkout_date"
    ],
    "library_books": [
    ...
    "user_accounts": [
        "user_id", "username",
        "password_hash", "role",
        "linked_id", "last_login"
    ],
    "audit_logs": [
        "log_id", "user_id",
        "action", "ip_address", "action_time"
    ]
}